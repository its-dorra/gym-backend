...
import { createdSchema, forbiddenSchema, internalServerErrorSchema, notFoundSchema, okSchema, queryParamSchema, unauthorizedSchema } from "@/lib/zod-schemas";
...
export const create = createRoute({
  ...
  responses: {
    [HttpStatusCodes.CREATED]: jsonContent(createdSchema, "The created Employee"),
    [HttpStatusCodes.UNAUTHORIZED]: jsonContent(unauthorizedSchema, HttpStatusPhrases.UNAUTHORIZED),
    [HttpStatusCodes.FORBIDDEN]: jsonContent(forbiddenSchema, HttpStatusPhrases.FORBIDDEN),
