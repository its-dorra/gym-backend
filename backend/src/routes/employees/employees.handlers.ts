...
import { createEmployee, deleteEmployee, getEmployees, getOneEmployee, updateEmployee } from "@/data-access/employees";
...
export const list: AppRouteHandler<ListRoute> = async (c) => {
  ...
  const [result, error] = await catchErrorTyped(getEmployees({ page, pageSize }));
